                  ...
                  @foreach ($usuario as $item)                      
                     <tbody>                     
                           <tr>
                              ...
                              <td class="col-2">
                                 <a class="btn btn-xs mx-1 pt-1 btn-outline-success" onclick="visualizarUser('{{ $item->name }}', '{{ $item->email }}')">                           
...
<script>
   function visualizarUser( name, email ) {
      // Atualiza o conteúdo do modal com os detalhes fornecidos
      $('#MyModalLabelName').text(name);      
